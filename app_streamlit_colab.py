# -*- coding: utf-8 -*-
"""app_streamlit_colab.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1cKqXNthmCIJz5iS68r5uB-qobbzD16pu
...
def grafico_mercado(a,b,Q_star,P_star,titulo):
    ...
    ax.scatter(Q_star,P_star,s=100)
    ax.axvline(Q_star, linestyle="--")
    ax.axhline(P_star, linestyle="--")
...
def grafico_cournot(a,b,c1,c2,q1_star,q2_star):
    ...
    ax.scatter(q2_star,q1_star,s=100)
    ax.set_xlabel('q2')
    ax.set_ylabel('q1')
...
def grafico_stackelberg(a,b,c2,q1_star,q2_star):
    ...
    ax.scatter(q1_star,q2_star,s=100)
    ax.axvline(q1_star, linestyle='--')
    ax.axhline(q2_star, linestyle='--')
